...
import com.example.keirekipro.presentation.resume.controller.DeleteCertificationController;
...
@WebMvcTest(DeleteCertificationController.class)
...
class DeleteCertificationControllerTest {
    ...
    private static final UUID CERTIFICATION_ID = UUID.fromString("33333333-3333-3333-3333-333333333333");
    ...
    void test1() throws Exception {
        ...
        mockMvc.perform(delete(ENDPOINT, RESUME_ID, CERTIFICATION_ID))
