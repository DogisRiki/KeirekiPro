package com.example.keirekipro.unit.usecase.techstack;
...
class GetTechStackListUseCaseTest {

    @Mock
    private TechStackMapper techStackMapper;

    @InjectMocks
    private GetTechStackListUseCase useCase;
    ...
    void test1() {
        ...
        // 実行
        TechStackListUseCaseDto actual = useCase.execute();
    ...
    void test2() {
        ...
        // frontend
        assertThat(actual.getFrontend().getLanguages())
                .containsExactly("JavaScript");
        assertThat(actual.getFrontend().getFrameworks())
                .containsExactly("React");
        assertThat(actual.getFrontend().getLibraries())
                .containsExactly("Zustand");
        assertThat(actual.getFrontend().getBuildTools())
                .containsExactly("Vite");
        assertThat(actual.getFrontend().getPackageManagers())
                .containsExactly("npm");
        assertThat(actual.getFrontend().getLinters())
                .containsExactly("ESLint");
        assertThat(actual.getFrontend().getFormatters())
                .containsExactly("Prettier");
        assertThat(actual.getFrontend().getTestingTools())
                .containsExactly("Jest");

        // backend
        assertThat(actual.getBackend().getLanguages())
                .containsExactly("Java");
        assertThat(actual.getBackend().getFrameworks())
                .containsExactly("Spring Boot");
        assertThat(actual.getBackend().getLibraries())
                .containsExactly("Lombok");
        assertThat(actual.getBackend().getBuildTools())
                .containsExactly("Gradle");
        assertThat(actual.getBackend().getPackageManagers())
                .containsExactly("Maven");
        assertThat(actual.getBackend().getLinters())
                .containsExactly("Checkstyle");
        assertThat(actual.getBackend().getFormatters())
                .containsExactly("google-java-format");
        assertThat(actual.getBackend().getTestingTools())
                .containsExactly("JUnit");
        assertThat(actual.getBackend().getOrmTools())
                .containsExactly("Hibernate");
        assertThat(actual.getBackend().getAuth())
                .containsExactly("Spring Security");

        // infrastructure
        assertThat(actual.getInfrastructure().getClouds())
                .containsExactly("AWS");
        assertThat(actual.getInfrastructure().getOperatingSystems())
                .containsExactly("Ubuntu");
        assertThat(actual.getInfrastructure().getContainers())
                .containsExactly("Docker");
        assertThat(actual.getInfrastructure().getDatabases())
                .containsExactly("PostgreSQL");
        assertThat(actual.getInfrastructure().getWebServers())
                .containsExactly("Nginx");
        assertThat(actual.getInfrastructure().getCiCdTools())
                .containsExactly("GitHub Actions");
        assertThat(actual.getInfrastructure().getIacTools())
                .containsExactly("Terraform");
        assertThat(actual.getInfrastructure().getMonitoringTools())
                .containsExactly("CloudWatch");
        assertThat(actual.getInfrastructure().getLoggingTools())
                .containsExactly("Fluentd");

        // tools
        assertThat(actual.getTools().getSourceControls())
                .containsExactly("Git");
        assertThat(actual.getTools().getProjectManagements())
                .containsExactly("Redmine");
        assertThat(actual.getTools().getCommunicationTools())
                .containsExactly("Slack");
        assertThat(actual.getTools().getDocumentationTools())
                .containsExactly("Confluence");
        assertThat(actual.getTools().getApiDevelopmentTools())
                .containsExactly("Postman");
        assertThat(actual.getTools().getDesignTools())
                .containsExactly("Figma");
        assertThat(actual.getTools().getEditors())
                .containsExactly("VS Code");
        assertThat(actual.getTools().getDevelopmentEnvironments())
                .containsExactly("WSL2");
