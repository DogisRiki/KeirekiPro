...
import com.example.keirekipro.presentation.resume.controller.UpdateSnsPlatformController;
...
@WebMvcTest(UpdateSnsPlatformController.class)
@AutoConfigureMockMvc(addFilters = false)
@TestConstructor(autowireMode = AutowireMode.ALL)
@RequiredArgsConstructor
class UpdateSnsPlatformControllerTest {
    ...
    private static final UUID SNS_PLATFORM_ID = UUID.fromString("88888888-8888-8888-8888-888888888888");
    ...
    void test1() throws Exception {
        // リクエスト作成
        UpdateSnsPlatformRequest req = new UpdateSnsPlatformRequest(
                "GitHub",
