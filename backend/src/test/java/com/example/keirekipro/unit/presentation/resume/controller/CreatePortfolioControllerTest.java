...
import com.example.keirekipro.presentation.resume.controller.CreatePortfolioController;
...
@WebMvcTest(CreatePortfolioController.class)
...
class CreatePortfolioControllerTest {
    ...
    private static CreatePortfolioRequest buildValidRequest() {
    ...
    void test1() throws Exception {
        CreatePortfolioRequest req = buildValidRequest();
    ...
    void test6() throws Exception {
        CreatePortfolioRequest req = buildValidRequest();
        req.setTechStack("a".repeat(1001));
        String body = objectMapper.writeValueAsString(req);
    ...
    void test8() throws Exception {
        CreatePortfolioRequest req = buildValidRequest();
        req.setLink("http://example.com/portfolio");
        String body = objectMapper.writeValueAsString(req);
