...
/**
 * 職務経歴書 自己PR新規作成コントローラー
 */
@RestController
@RequestMapping("/api/resumes")
@RequiredArgsConstructor
@Tag(name = "resumes", description = "職務経歴書に関するエンドポイント")
public class CreateSelfPromotionController {

    private final CreateSelfPromotionUseCase createSelfPromotionUseCase;
     ...
     * 自己PR新規作成エンドポイント
     */
    @PostMapping("/{resumeId}/self-promotions")
