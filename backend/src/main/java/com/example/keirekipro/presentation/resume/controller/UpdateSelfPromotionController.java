...
public class UpdateSelfPromotionController {

    private final UpdateSelfPromotionUseCase updateSelfPromotionUseCase;
     ...
     * 自己PR更新エンドポイント
     */
    @PutMapping("/{resumeId}/self-promotions/{selfPromotionId}")
