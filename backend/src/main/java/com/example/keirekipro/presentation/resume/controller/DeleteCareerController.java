...
public class DeleteCareerController {
    ...
    private final DeleteCareerUseCase deleteCareerUseCase;
    ...
    @Operation(summary = "職務経歴書 職歴削除", description = "職務経歴書の職歴を削除する")
    public void handle(
        ...
        deleteCareerUseCase.execute(userId, resumeId, careerId);
    }
}
