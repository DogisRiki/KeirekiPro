  ...
  "Statement": [
    ...
    },
    {
      ...
      "Condition": {
        ...
        "StringLike": {
          "token.actions.githubusercontent.com:job_workflow_ref": "<GitHubユーザー名>/KeirekiPro/.github/workflows/terraform-plan.yaml@*"
        }
      }
    },
    {
      ...
      "Condition": {
        "StringEquals": {
          ...
          "token.actions.githubusercontent.com:job_workflow_ref": "<GitHubユーザー名>/KeirekiPro/.github/workflows/terraform-apply.yaml@refs/heads/main"
        }
      }
    }
  ]
...
信頼ポリシーの environment 条件と対になる設定。**リポジトリの** Settings → Environments →
`production` を開き、次を設定する。
